    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            if(location.state) {
                ...
                // const response = await fetchWithAuth(`http://localhost:8080/api/v1/notifications/send/projects/${ values.project.split(':')[0] }/tasks/${ location.state.task.id }`, {
                //     method: "POST",
                //     body: JSON.stringify({
                ...
                // const response = await fetchWithAuth(`http://localhost:8080/api/v1/notifications/send/projects/${ values.project.split(':')[0] }/tasks/${newTaskData.id}`, {
                //     method: "POST",
                //     body: JSON.stringify({
                //         "senderId": user.employeeId,
                //         "receiverId": user.employeeId,
